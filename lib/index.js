...
var AmazonScraper = /** @class */ (function () {
    ...
    AmazonScraper.prototype.processProductPage = function ($) {
        return __awaiter(this, void 0, void 0, function () {
            var title, price, merchantId, isAvailable, salesRank, asin, productObject;
            return __generator(this, function (_a) {
     ...
     * @memberof AmazonScraper
     */
    AmazonScraper.prototype.processCheckoutPage = function ($) {
        ...
        var remainingInvDiv = $(this.remainingInventorySelector);
        var inventoryNumber = Number(inventoryText
            ...
            .replace('items', '')
            .replace('item', ''));
        var hiddenInventoryConfirmation = Number($(remainingInvDiv)
            .val()
            .split(',')[1]);
    ...
    AmazonScraper.prototype.getFullProductInformation = function () {
        return __awaiter(this, void 0, void 0, function () {
            var productPageSelector, productObject, formObject, inventoryPageSelector, productObjectWithInventory;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, this.getIAmazonFormObject(productPageSelector)];
                    case 3:
                        formObject = _a.sent();
                        if (!formObject) {
                    ...
                    case 4:
                        ...
                        productObjectWithInventory = __assign({}, productObject, { inventorySize: this.processCheckoutPage(inventoryPageSelector) });
    ...
    AmazonScraper.prototype.scrapeProductPrice = function ($) {
        var priceId = _.find(this.priceSelectors, function (id) {
            return $(id).length > 0;
        });
        if (!priceId) {
            return null;
    ...
    AmazonScraper.prototype.scrapeSalesRank = function ($) {
        ...
        var salesRankStr = $(salesRankItem)
            ...
            .replace(',', '')
            .replace('n°', '');
        var salesRank = parseInt(salesRankStr, 2);
        return salesRank;
    };
    /**
     ...
     * @memberof AmazonScraper
     */
    AmazonScraper.prototype.getIAmazonFormObject = function ($) {
        var rootUrl = Url.parse(this.productUrl);
        var formData = {};
        var cartId = _.find(this.addToCardBtnSelectors, function (id) {
            return $(id).length > 0;
        });
        if (!cartId) {
            return null;
